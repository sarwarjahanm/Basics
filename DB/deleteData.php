...
<body style="background-image: url(http://localhost:81/Basics/DB/img/db.png); background-position: center"> <button onclick="mainpage()">Main Page</button> <button onclick="insert()">Insert Data</button><br/>
