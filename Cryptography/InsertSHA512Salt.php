...
if($_SERVER["REQUEST_METHOD"] == "POST") { 
	...
	$hashedpw = hash('sha512', $salt.$password);

			
	$sql2 = "Select * from sha512salt";
	$sql3 = "INSERT INTO `sha512salt` ( `username`,`password`,`salt`) VALUES ('$username','$hashedpw','$salt')";
...
<head> 
	...
	<script>
function insertjs() {
  location.replace("http://localhost:81/Basics/cryptography/SHA512Salt.html")
}
</script>
...
<?php 
	  ...
	  echo '<table style="border: 1px solid black;margin-left:auto;margin-right:auto; "> 
			...
			echo '<tr style="border: 1px solid black;">
					...
					<td style="border: 1px solid black;">'.$info["salt"].'</td>
				  </tr>'; 
