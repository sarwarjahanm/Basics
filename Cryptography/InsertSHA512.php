...
if($_SERVER["REQUEST_METHOD"] == "POST") { 
	...
	$sql2 = "Select * from sha512";
	$sql3 = "INSERT INTO `sha512` ( `username`,`password`) VALUES ('$username','$hashedpw')";
...
<head> 
	...
	<script>
function insertjs() {
  location.replace("http://localhost:81/Basics/cryptography/SHA512.html")
}
</script>
